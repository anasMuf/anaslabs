...
| --- | --- | --- |
| **User** | Menentukan budget mingguan sebesar Rp700.000 | Saya punya batasan harian yang jelas dan tidak boros. |
| **User** | Mencatat pengeluaran makan siang dengan cepat | Saya tidak lupa mencatat detail kecil saat sedang bepergian. |
| **User** | Melihat persentase budget yang sudah terpakai di dashboard | Saya bisa mengerem pengeluaran jika kuota sudah mencapai 80%. |
| **User** | Mengedit atau menghapus transaksi yang salah input | Data keuangan saya tetap akurat. |
| **User** | Melihat rekap pengeluaran minggu lalu | Saya bisa mengevaluasi apakah budget minggu ini perlu ditambah atau dikurangi. |
